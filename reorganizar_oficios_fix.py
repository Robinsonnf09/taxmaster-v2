"""
REORGANIZAR OFÍCIOS - VERSÃO CORRIGIDA
"""
...
class ReorganizadorOficios:
    ...
    def extrair_orgao_devedor(self, pdf_path):
        ...
        try:
            with open(pdf_path, 'rb') as file:
                ...
                if 'tribunal de justiça' in texto_lower:
    ...
    def reorganizar(self):
        ...
        for idx, pdf in enumerate(pdfs, 1):
            if idx % 50 == 0 or idx == 1:
                print(f"   📋 {idx}/{total} ({idx/total*100:.1f}%) - {len(self.estatisticas)} órgãos", end="\r")
    ...
    def gerar_relatorio(self):
        ...
        for idx, (orgao, dados) in enumerate(ordenados, 1):
            ...
            print(f"   {idx:3d}  {orgao_exibir:48s}  {dados['quantidade']:8d}  {perc:6.1f}%")
        
        print(f"\n        TOTAL                                              {total:8d}  100.0%")
